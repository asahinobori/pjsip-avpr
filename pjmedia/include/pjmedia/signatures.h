...
#define PJMEDIA_SIG_PORT_OPUS_PLAYER	PJMEDIA_SIG_CLASS_PORT_AUD('O','P')
...
/** WEBM player signature. */
#define PJMEDIA_SIG_PORT_VID_WEBM_PLAYER PJMEDIA_SIG_CLASS_PORT_VID('W','M')
/** WEBM writer signature. */
#define PJMEDIA_SIG_PORT_VID_WEBM_WRITER PJMEDIA_SIG_CLASS_PORT_VID('W','W')
