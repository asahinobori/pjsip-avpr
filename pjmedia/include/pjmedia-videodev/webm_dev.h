 ...
 */
#ifndef PJMEDIA_VIDEODEV_WEBM_DEV_H__
#define PJMEDIA_VIDEODEV_WEBM_DEV_H__

/**
 * @file webm_dev.h
 * @brief WEBM player virtual device
 */
...
/**
 * @defgroup webm_dev WEBM Player Virtual Device
 * @ingroup video_device_api
 * @brief WEBM player virtual device
 * @{
 * This describes a virtual capture device which takes its input from an WEBM
 * file.
 */

/**
 * Settings for the WEBM player virtual device. This param corresponds to
 * PJMEDIA_VID_DEV_CAP_WEBM_PLAY capability of the video device/stream.
 */
typedef struct pjmedia_webm_dev_param
{
    /**
     * Specifies the full path of the WEBM file to be played.
     */
    pj_str_t	path;
 ...
 */
PJ_DECL(void) pjmedia_webm_dev_param_default(pjmedia_webm_dev_param *p);
 ...
 */
PJ_DECL(pj_status_t) pjmedia_webm_dev_create_factory(
				    pj_pool_factory *pf,
				    unsigned max_dev,
				    pjmedia_vid_dev_factory **p_ret);

/**
 * Allocate one device ID to be used to play the specified WEBM file in
 * the parameter.
 *
 ...
 *
 */
PJ_DECL(pj_status_t) pjmedia_webm_dev_alloc(pjmedia_vid_dev_factory *f,
                                           pjmedia_webm_dev_param *param,
 ...
 * @return		PJ_SUCCESS or the appropriate error code.
 */
PJ_DECL(pj_status_t) pjmedia_webm_dev_get_param(pjmedia_vid_dev_index id,
                                               pjmedia_webm_dev_param *param);
 ...
 * @return		PJ_SUCCESS or the appropriate error code.
 */
PJ_DECL(pj_status_t) pjmedia_webm_dev_free(pjmedia_vid_dev_index id);
